use shared::{
    ...
    TilePos, WorldPos, Direction, StationType, Color,
...
fn main() {
    ...
    let station1 = create_station_entity(&mut entities, TilePos::new(7, 7), StationType::WeaponLaser);
    ...
    println!("Visible tiles from ({}, {}): {} tiles", 
        viewer_pos.x, viewer_pos.y, visibility.visible_tiles.len());
    ...
    println!("Found {} windows providing extended vision", window_result.window_views.len());
        ...
        for x in 0..width {
            ...
            if x == 0 || x == width - 1 || y == 0 || y == height - 1 {
                if x == width / 2 && y == 0 {
                    ...
                    tile_map.set_static_tile(pos, StaticTile::Window { facing: Direction::Up });
                } else {
...
fn create_station_entity(
    ...
    entities.add_station(entity_id, Station {
        station_type,
